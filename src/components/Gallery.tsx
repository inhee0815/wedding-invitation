...
const photos: Photo[] = [
  ...
  { id: 10, url: 'images/gallery10.jpg', alt: 'Wedding Photo 10', thumbnailPosition: 'center 49%' },
  { id: 11, url: 'images/gallery11.jpg', alt: 'Wedding Photo 11', thumbnailPosition: 'center 49%' },
